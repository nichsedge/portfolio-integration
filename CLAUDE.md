...
cd /home/al/Projects/portfolio_integration
uv sync
...
All output files use `pendulum` for date formatting and are stored in the data directory (`PORTFOLIO_DATA_DIR` or `/home/al/Projects/.data/portfolio/`):
