...
const getDataDir = () => {
  return process.env.PORTFOLIO_DATA_DIR || process.env.DATA_DIR || '/REDACTED_HOME/Projects/.data/portfolio';
};
...
const OUTPUT_PATH = `${dataDir}/${currentDate}_raw_debank.json`;
